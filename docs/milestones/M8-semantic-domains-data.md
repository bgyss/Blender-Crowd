...
- For a reactive combat pack: licensed paired motion and weapon assets,
  interaction/contact fixtures, opponent-perturbation tests, deterministic
  fallback coverage, and reproducible attack-parry, evade-counter, and
  hit-reaction-recovery reference scenes.
